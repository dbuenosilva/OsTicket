    ...
    */
    ...
    function create($vars) {
        ...
        $sql=' INSERT INTO '.TICKET_THREAD_TABLE.' SET created=NOW() '
			...
			.' ,tipoatende='.db_input($vars['tipoatende'])
            .' ,user_id='.db_input($vars['userId'])
			.' ,chamado='.db_input($vars['chamado'])
			.' ,1saida='.db_input($vars['1entrada'].' '.$vars['hsai'])
			.' ,1entrada='.db_input($vars['1entrada'].' '.$vars['hentra'])
			.' ,2saida='.db_input($vars['1entrada'].' '.$vars['hsai2'])
			.' ,2entrada='.db_input($vars['1entrada'].' '.$vars['hentra2'])
			.' ,3saida='.db_input($vars['1entrada'].' '.$vars['hsai3'])
			.' ,3entrada='.db_input($vars['1entrada'].' '.$vars['hentra3'])
