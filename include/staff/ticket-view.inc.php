...
<tr>
            ...
            <tr>
            	...
            	<td>
            		<input name="1entrada" id="1entrada" class="dp" value="<?php echo Format::htmlchars($info['1entrada']); ?>" size="12" autocomplete=OFF/>
            		 &nbsp;<font class="error">&nbsp;*&nbsp;<?=$errors['1entrada'];?>&nbsp;&nbsp;&nbsp;</font>
            	</td>
            </tr>
            <tr>
            	<td>
                ...
                $min=$hr=null;
                if($info['hentra'])
                    list($hr, $min)=explode(':', $info['hentra']);
            ...
            <tr>
                ...
                $min=$hr=null;
                if($info['hentra2'])
                    list($hr, $min)=explode(':', $info['hentra2']);
            ...
            <tr>
                ...
                echo Misc::timeDropdown($hr, $min, 'hsai2');
                ?>
            &nbsp;<font class="error">&nbsp;*&nbsp;<?=$errors['hsai2'];?>&nbsp;	</font>
             ...
             <tr>
                ...
                $min=$hr=null;
                if($info['hentra3'])
                    list($hr, $min)=explode(':', $info['hentra3']);
                ...
                echo Misc::timeDropdown($hr, $min, 'hsai3');
                ?>
