...
define('PHPGRID_DB_HOSTNAME', 'mysql.gwaya.com:3306'); // database host name
define('PHPGRID_DB_USERNAME', 'gwaya06');     // database user name
define('PHPGRID_DB_PASSWORD', 'h3lpd3sk'); // database password
define('PHPGRID_DB_NAME', 'gwaya06'); // database name
